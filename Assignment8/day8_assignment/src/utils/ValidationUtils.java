...
public class ValidationUtils 
{
	...
	public static String correctemail(String str,Customer [] customer) throws Exception
	{
		
		String regex="^[a-zA-Z0-9+_.-]+@[a-zA-Z0-9.-]+$";
		if(str.matches(regex))
		{
			boolean b=checkDuplication(str,customer);
			if(b==true)
			{
	...
	public static boolean checkDuplication(String str,Customer[]customer)
	{
		Customer newCustomer=new Customer(str);
