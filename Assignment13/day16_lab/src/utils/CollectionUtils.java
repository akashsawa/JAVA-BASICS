...
//	}
	...
	public static ArrayList<BankAccount> populateSampleData() {
		...
		try {
			...
			list.add(new BankAccount(45, "Kiran", SAVING, convertDate("6-5-2020"), 5600, "hdfc-001"));
			list.add(new BankAccount(156, "Geeta", FD, convertDate("24-1-2011"), 1235600, "hdfc-001"));
			list.add(new BankAccount(56, "Priya", SAVING, convertDate("21-3-2018"), 4500, "hdfc-001"));
